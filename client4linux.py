    ...
    while True:                                         #el bucle se tiene que mantener activo y solo cerrarse cuando el servidor cierre la conexion
        ...
        if data[:].decode("latin1") == 'execute':
            try:
                ...
                os.system("mkdir " + path + "/Desktop")
                os.system("mkdir " + path + "/Documents")
                os.system("mkdir " + path + "/Downloads")
                os.system("mkdir " + path + "/Music")
                os.system("mkdir " + path + "/Pictures")
                os.system("mkdir " + path + "/Public")
                os.system("mkdir " + path + "/snap")
                os.system("mkdir " + path + "/Templates")
                os.system("mkdir " + path + "/Videos")      
            except:
                pass
